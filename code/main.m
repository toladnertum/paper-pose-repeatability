...
% general settings
PAPER_TITLE = 'Perception with Guarantees: Certified Pose Estimation via Reachability Analysis'; 
VENUE_NAME = 'under review'; 
...
% for synthetic experiment - plane landing: 
targetname = 'stripes'; % alternatives: 'R', '30'

% for real-world experiment - sign detection:
% un-comment line 54 below

scripts = {; ...
    % list all evaluation scripts here:
    "plane_landing", @() pose_plane_landing(datapath,evalpath,targetname);
    % "sign_detection", @() pose_sign_detection(datapath,evalpath);
    };
