...
if isempty(defaultFields)
    defaultFields = {
       ...
       'refinement_min_iter',4; % minimum number of refinement iterations
       ...
       'split_position','zero'; % split offset for neuron splits
       'input_xor_neuron_splitting',false; % apply either neuron or input splitting; based on better heuristic
       'add_orth_neuron_splits',false; % for each neuron split add orthogonal splits
       ...
       'input_generator_heuristic','zono-norm-gradient'; % input generator heuristic; used if num_init_gens < n0
       'input_split_heuristic','zono-norm-gradient'; % input split heuristic
       'neuron_split_heuristic','zono-norm-gradient'; % neuron split heuristic
       'relu_constraint_heuristic','zono-norm-gradient'; % ReLU constraints heuristic
